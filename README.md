...
CUDA_VISIBLE_DEVICES=0 transformers serve --port 23333 --trust-remote-code

CUDA_VISIBLE_DEVICES=2 transformers serve --port 23333 --device cuda --dtype auto --trust-remote-code
